...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { advanced: @machine.advanced, boolean: @machine.boolean, name: @machine.name, type: @machine.type } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { advanced: @machine.advanced, boolean: @machine.boolean, name: @machine.name, type: @machine.type } }
